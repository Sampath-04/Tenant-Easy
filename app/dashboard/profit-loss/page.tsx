    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-900">
      ...
      <div className="px-4 sm:px-6 lg:px-8 pt-3">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
          <div>
            <p className="text-slate-600 dark:text-slate-400 text-xl font-bold my-2">
        ...
        {profitLossResponse?.data && !isLoading && (
          <div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-[1fr_500px] gap-8'>
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <p className={`text-2xl font-bold ${summaryStats.totalNetProfit >= 0 ? 'text-blue-600 dark:text-blue-400' : 'text-orange-600 dark:text-orange-400'}`}>
                                {formatCurrency(summaryStats.totalNetProfit)}
                            </p>
                            </div>
                            <div className={`p-3 rounded-full ${summaryStats.totalNetProfit >= 0 ? 'bg-blue-100 dark:bg-blue-900/20' : 'bg-orange-100 dark:bg-orange-900/20'}`}>
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 h-[calc(100vh-300px)] overflow-y-scroll">
                            ...
                            <table className="w-full">
                                ...
                                >
                                    <td className="px-6 py-4">
                                        ...
                                        <div className="text-xs text-slate-500 dark:text-slate-400">{record.year}</div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <div className="text-sm font-medium text-slate-900 dark:text-slate-100">
                ...
                {/* Charts Section */}
                <div className="grid gap-8 mb-8 w-auto">
